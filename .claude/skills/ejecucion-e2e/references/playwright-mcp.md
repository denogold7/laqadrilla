...
- Gotcha: la primera vez, nombra **"Playwright MCP"** en el pedido; si no, a veces se intenta correr Playwright por Bash en lugar del MCP.
...
- **Esperas**: espera visibilidad/estabilidad antes de actuar; reintenta con un nuevo snapshot ante "no encontrado" antes de marcar fallo.
