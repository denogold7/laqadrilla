...
**Cómo.**
1. Por cada entrada, identifica las clases **válidas** (lo que el sistema acepta) y las **inválidas** (lo que debe rechazar).
2. Elegí un representante de cada clase.
3. Genera un caso por representante.
...
**Cómo.**
1. Lista las condiciones y las acciones.
2. Arma una columna por combinación de condiciones (Sí/No).
...
**Cómo.**
1. Lista los estados y los eventos.
...
**Cómo.** Lista los parámetros y sus valores, y arma un conjunto mínimo de combinaciones que incluya cada par (un valor de A junto a un valor de B) al menos una vez. Hay herramientas que lo generan (PICT, AllPairs).
